...
function addGamesToPage(games) {
    ...
    for (const game of games) {
        ...
        gameCard.innerHTML = 
        `
        <img src=${game.img} alt="Cover art for ${game.name}" style="max-width:100%; height: auto;"/>
        <h3>${game.name}</h3>
        <p>${game.description}</p>
        <p>Backers: <b>${game.backers}</b></p>
        `;
...
const displayStr = `A total of $${totalPledged.toLocaleString('us-en')} has been raised for ${gamesCount} games. Currently,
